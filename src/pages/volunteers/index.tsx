...
import {
  ...
  UserCheck, FolderKanban, Send, Upload, Download, FileSpreadsheet,
} from "lucide-react"
...
function downloadVolCSVTemplate() {
  ...
  a.href = url; a.download = "volunteers_template.csv"; a.click()
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-[500px]">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-blue-700 mt-0.5">Fill in one volunteer per row. Use semicolons to separate multiple skills, languages, and interests.</p>
                <button onClick={downloadVolCSVTemplate}
        ...
        <div className="flex gap-2 px-5 py-4 border-t border-gray-100">
          ...
          <Button className="flex-1" disabled={!file}><Upload className="w-3.5 h-3.5" /> Import {file ? "Volunteers" : ""}</Button>
        </div>
      </div>
    </div>
  )
      ...
      <div className="bg-white rounded-xl shadow-xl w-[600px] max-h-[90vh] flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-6">
          ...
          <div className={SEC_CLS}>
            <p className={SEC_TITLE_CLS}>Basic Info</p>
          ...
          {/* Contact */}
          <div className={SEC_CLS}>
            <p className={SEC_TITLE_CLS}>Contact</p>
            <div className="grid grid-cols-2 gap-3">
              <div>
          ...
          {/* Volunteer Group */}
          <div className={SEC_CLS}>
            <p className={SEC_TITLE_CLS}>Volunteer Group</p>
            <div>
          ...
          <div className={SEC_CLS}>
            <p className={SEC_TITLE_CLS}>Volunteering Preferences</p>
            <div className="grid grid-cols-2 gap-3">
              <div>
          ...
          {/* Skills */}
          <div className={SEC_CLS}>
            <p className={SEC_TITLE_CLS}>Skills</p>
            <div>
